...

{
    ...
    public partial class PokemonDetails
    {
        public static PokemonDetails FromJson(string json) => JsonConvert.DeserializeObject<PokemonDetails>(json, Converter.Settings);
    }

    //public static class Serialize
    //{
    //    public static string ToJson(this PokemonDetails self) => JsonConvert.SerializeObject(self, Converter.Settings);
    //}
